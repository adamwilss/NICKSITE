...
const products = [
  {
    ...
    from: 'From £290',
    badge: 'Most Popular',
    features: ['A3 pencil originals', '9–11 per hour (~5 min each)', 'UK & international', 'Min. 2 hours'],
  },
  {
...
const pricingTiers = [
  ...
  },
  {
    name: '4 Hours',
    price: 'From £425',
    description: 'Ideal for large galas, corporate parties, and full-evening events.',
    features: [
      '4-hour booking',
      '36–44 caricatures (~5 min each)',
      'Pencil on A3 paper',
      'Colour options available',
      'Full public liability insurance',
    ],
